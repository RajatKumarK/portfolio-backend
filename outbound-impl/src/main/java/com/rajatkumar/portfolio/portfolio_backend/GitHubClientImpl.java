...
public class GitHubClientImpl implements GitHubClient {
  ...
  private final String username;
  private final String token; // Optional for higher rate limits
  ...
  public List<GitHubRepositoryDto> getUserRepositories() {
    ...
    String url = apiBaseUrl + "/users/" + username + "/repos?sort=updated&per_page=100";
  ...
  // Get additional repository details like languages used
  public Map<String, Long> getRepositoryLanguages(String repoName) {
    ...
    String url = apiBaseUrl + "/repos/" + username + "/" + repoName + "/languages";
